...
async function main() {
  ...
  try {
    ...
    console.error('Expected:', JSON.stringify(forecastExpected, null, 2))
    throw e
  }

  console.log('Testing Churn Regression...')
  const { stdout: chOut, stderr: chErr } = await execAsync('python3 ml/churn.py', { env })
  console.log('Churn stderr:', chErr)
  ...
  try {
    ...
    console.error('Actual:', JSON.stringify(chActual, null, 2))
    console.error('Expected:', JSON.stringify(churnExpected, null, 2))
    throw e
  }
